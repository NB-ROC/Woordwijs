...
async function startOefening({ melding = true } = {}) {
...
chrome.runtime.onInstalled.addListener(async ({ reason }) => {
  ...
  // Na installeren meteen het venster openen, zodat je kunt inloggen.
  if (reason === "install") await startOefening({ melding: false });
});
